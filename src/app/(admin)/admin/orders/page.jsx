...
import { DeleteOutlined, EyeOutlined, HomeOutlined, SearchOutlined } from "@ant-design/icons"
...
export default function Categorys() {
  ...
  const updateStatusOrderMutate = useMutation(data => Order.updateStatusOrder(data.id, data), {
    onSuccess: () => {
      ...
      render: (_, record) => (
        <div className="flex gap-2">
          ...
          <Popconfirm
            ...
            okText="Có"
            cancelText="Không">
            <Button size="middle" type="default" icon={<DeleteOutlined />} danger>
              Xóa
            </Button>
          </Popconfirm>
        </div>
