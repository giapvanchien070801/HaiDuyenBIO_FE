...
const LayoutAdmin = ({ children }) => {
  ...
  const titleHover = (
    <div className=" flex gap-2 cursor-pointer">
      <Avatar size={40} src="https://adminlte.io/themes/v3/dist/img/user8-128x128.jpg" shape="square" />
      <div>
        <p>Giáp Văn Chiến</p>
  ...
  return (
    ...
    <div className=" flex">
      ...
      {/* main content */}
      <div className={` w-full h-[100vh] content-wraper bg-[#f3f3f5] ${isCloseMenu ? "ml-[70px]" : "ml-64"}`}>
        {/* header */}
