                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            HẢI DUYÊN BIO là thương hiệu thuộc Công ty TNHH Ứng dụng công nghệ Vi sinh JAPAN, chuyên
                            cung cấp giải pháp sinh học xử lý môi trường và ao nuôi tôm.
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">
                            Hải Duyên Bio tự hào là công ty tiên phong trong việc ứng dụng công nghệ sinh học hiện đại
                            vào sản xuất các sản phẩm men vi sinh chất lượng cao.
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300">
                    ...
                    <div className="space-y-4 text-gray-700">
                      <p className="text-lg leading-relaxed">
                        ...
                        <span className="font-semibold text-blue-700">đối tác tin cậy</span> trong lĩnh vực giải pháp
                        công nghệ sinh học.
                      </p>
                      <p className="text-lg leading-relaxed">
                        Phấn đấu trở thành <span className="font-semibold text-blue-700">lựa chọn số 1</span> về cung
                        cấp giải pháp và sản phẩm hiệu quả vượt trội trong xử lý môi trường ao nuôi tôm, đồng hành cùng
                        người nuôi tôm trên con đường thành công.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-600">Nam Điện - Nam Dương - Bắc Ninh</p>
                        </div>
                      </div>
                    </div>
