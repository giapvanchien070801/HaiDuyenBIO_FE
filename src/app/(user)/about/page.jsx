                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          HẢI DUYÊN BIO là thương hiệu thuộc Công ty TNHH Ứng
                          dụng công nghệ Vi sinh JAPAN, chuyên cung cấp giải
                          pháp sinh học xử lý môi trường và ao nuôi tôm.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Chúng tôi hiện đang sản xuất và phân phối trực tiếp
                          các sản phẩm men vi sinh chất lượng cao cho nuôi trồng
                          thủy sản, được sản xuất trực tiếp tại nhà máy.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">
                          Hải Duyên Bio tự hào là công ty tiên phong trong việc
                          ứng dụng công nghệ sinh học hiện đại vào sản xuất các
                          sản phẩm men vi sinh chất lượng cao.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-100 p-4 rounded-lg border-l-4 border-blue-500">
                      <p className="text-blue-800 italic">
                        "Với sứ mệnh mang lại giải pháp bền vững cho ngành nuôi
                        trồng thủy sản, chúng tôi cam kết cung cấp các sản phẩm
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="bg-white p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-gray-600 text-center leading-relaxed">
                      Sản phẩm được sản xuất từ nguyên liệu tự nhiên cao cấp,
                      trải qua quy trình kiểm định nghiêm ngặt theo tiêu chuẩn
                      quốc tế.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-gray-600 text-center leading-relaxed">
                      Được tin dùng bởi hơn 1000+ trang trại nuôi trồng thủy sản
                      trên toàn quốc với tỷ lệ thành công cao.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-8 rounded-xl shadow-lg transform hover:scale-105 transition-transform duration-300">
                    ...
                    <p className="text-gray-600 text-center leading-relaxed">
                      Đội ngũ chuyên gia với 10+ năm kinh nghiệm luôn sẵn sàng
                      tư vấn và hỗ trợ kỹ thuật mọi lúc bạn cần.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p className="text-lg leading-relaxed">
                      ...
                      trong lĩnh vực giải pháp công nghệ sinh học.
                    </p>
                    <p className="text-lg leading-relaxed">
                      Phấn đấu trở thành{" "}
                      <span className="font-semibold text-blue-700">
                      ...
                      về cung cấp giải pháp và sản phẩm hiệu quả vượt trội trong
                      xử lý môi trường ao nuôi tôm, đồng hành cùng người nuôi
                      tôm trên con đường thành công.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-300">
                  ...
                  <div className="space-y-4 text-gray-700">
                    <p className="text-lg font-semibold italic text-green-700 border-l-4 border-green-500 pl-4">
                      "Cung cấp giải pháp và sản phẩm sinh học làm sạch môi
                      trường ao nuôi"
                    </p>
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Phát triển song hành cùng môi trường
                    </p>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600">
                      Giải pháp tối ưu cho người nuôi
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 py-5">
                          Địa chỉ văn phòng
                        </p>
                        <p className="text-gray-600">
                          Nam Điện – Nam Dương – Lục Ngạn – Bắc Giang
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 p-10 rounded-2xl text-white text-center shadow-xl transform hover:scale-[1.02] transition-all duration-300 border border-blue-400/20">
                <div className="max-w-2xl mx-auto">
                  ...
                  <p className="mb-8 text-lg text-blue-100 leading-relaxed">
                    Liên hệ ngay để được tư vấn chi tiết về sản phẩm men vi sinh
                    và giải pháp nuôi trồng tối ưu cho doanh nghiệp của bạn
                  </p>
