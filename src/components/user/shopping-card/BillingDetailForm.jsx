...
import { UserOutlined, HomeOutlined, PhoneOutlined, FileTextOutlined } from "@ant-design/icons"
    ...
    <div className="bg-white p-6 rounded-lg shadow-md w-1/2">
      ...
      <Form form={form} layout="vertical" className="space-y-4" onFinish={onFinish}>
        ...
        <Form.Item name="additionalInformation" label="Ghi chú">
          <Input.TextArea size="large" prefix={<FileTextOutlined />} placeholder="Nhập ghi chú (nếu có)" rows={4} />
        </Form.Item>
      </Form>
    </div>
  )
